...
const MainBody = () => {
  const userData = [
    { username: '_taha_umer_', imageUrl: user },
    { username: '_taha_umer_', imageUrl: user },
    { username: '_taha_umer_', imageUrl: user },
    { username: '_taha_umer_', imageUrl: user },
    { username: '_taha_umer_', imageUrl: user },
  ...
  const postData = [
    { username: '_taha_umer_', imageUrl: user, postLikes: '3,028', postComments: '164' },
    { username: 'user212', imageUrl: user, postLikes: '3', postComments: '16' },
    { username: 'its_user', imageUrl: user, postLikes: '22', postComments: '12' },
    { username: 'testing12', imageUrl: user, postLikes: '46,281', postComments: '1920' },
    { username: '1212_abc', imageUrl: user, postLikes: '2,123', postComments: '264' },
    { username: 'abc_def', imageUrl: user, postLikes: '30', postComments: '114' },
    { username: 'Users_121', imageUrl: user, postLikes: '28', postComments: '12' },
  ]
  return (
    <div>
      <Swiper slidesPerView={8} className="w-[650px] mb-10">
      ...
      <div key={index} className="text-white w-[466px] mx-auto divide-[#262626]">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center">
            <div className="w-[40px] rounded-full overflow-hidden instaGradient pl-[1px] pb-[1.2px] p-[2px] cursor-pointer">
              <img src={post.imageUrl} alt="" className="rounded-full border-[3px] border-black"/>
            </div>
            <h2 className="text-sm ml-3 font-semibold cursor-pointer">{post.username} <span className="text-[#9C9C9C]">• 4h</span></h2>
          </div>
        ...
        <h3 className="font-medium text-[14px] text-[#A8A8A8] cursor-pointer">View all {post.postComments} comments</h3>
        <input type="text" placeholder="Add a comment..." className="bg-transparent text-[14px] w-full outline-0"/>
        <hr className="my-4"/>
      </div>
      ))}
    </div>
